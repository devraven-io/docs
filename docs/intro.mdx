...
<ReactPlayer controls url='https://www.youtube.com/watch?v=ywtSn1Jc8jM' />
...
1. Click **API Monitors** in the left navigation menu.
2. Click **New Monitor** button.
3. Provide a **name** for the monitor.
4. Select an **environment** if applicable. [Environments](/docs/environments/overview) help externalizing variables without hardcoding your monitors and also those variables can be reused with multiple monitors.
5. Provide the **HTTP Request** details.
6. Select required assertions or use **After Request Script** for scripting complex custom assertions.
